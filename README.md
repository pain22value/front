...
- API 문서: [https://api.truve.site:8080/swagger-ui/index.html]([https://api.truve.site:8080/swagger-ui/index.html](http://api.truve.site:8080/swagger-ui/index.html?urls.primaryName=02-Payment+Service))
