...
import ArtistCommentDetail from "./post/ArtistCommentDetail";
...
export default function ArtistSide() {
  ...
  if (selectedPostId !== null) {
    return (
      <div className="relative w-full h-[calc(100vh-var(--header-height)-120px)] overflow-hidden bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm">
        {/* 댓글 목록 섹션 */}
  ...
  return (
    <div className="h-[calc(100vh-var(--header-height)-120px)] overflow-y-auto">
      <ArtistLiveChat />
    </div>
  );
}
