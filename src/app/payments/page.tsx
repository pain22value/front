...
import {
  useTossPayment,
  type PayMethod,
} from "@/features/payments/hooks/useTossPayment";
...
import {
  markBeRiskMockPendingSuccessWarning,
  prepareBeRiskMockPayment,
} from "@/shared/lib/beRiskMock";
...
export default function CheckoutPage() {
  ...
  const proceedPayment = async (
    beRiskCountForSuccessWarning: number | null = null,
  ) => {
  ...
  const handlePay = async () => {
    ...
    const newErrors = {
      name:
        !customerInfo.name || customerInfo.name === "미기입"
          ? "이름을 입력해주세요"
          : "",
      birth:
        !customerInfo.birth || customerInfo.birth === "미기입"
          ? "8자리의 생년월일을 입력해주세요"
          : "",
      email:
        !customerInfo.email || customerInfo.email === "미기입"
          ? "올바르지 않은 이메일 형식입니다"
          : "",
      phone:
        !customerInfo.phone || customerInfo.phone === "미기입"
          ? "-를 제외한 11자리의 전화번호를 입력해주세요"
          : "",
    };
    setErrors(newErrors);
    ...
    const successWarningRiskCount =
      mockResult.action === "allow" ? mockResult.riskCount : null;
    await proceedPayment(successWarningRiskCount);
  };

  const [payMethod, setPayMethod] = useState<PayMethod | undefined>(undefined);
  const [receipt, setReceipt] = useState<"NONE" | "PERSONAL" | "BIZ" | null>(
    null,
  );
  ...
  return (
    <div className="min-h-screen bg-white">
      <Modal
        ...
        subMessage={
          modal === "expired"
            ? "확인하면 예매 첫 화면으로 이동합니다."
            : modal === "back"
              ? "이동하면 진행 중인 예매가 취소됩니다."
              : undefined
        }
        onClose={() => {
      ...
      <header className="border-b border-gray-100">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 border-t border-b border-gray-100">
          <p className="text-[16px] font-bold text-[#23222A]">
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <button
          ...
          className="flex items-center gap-1 px-1 mb-8"
        >
          <svg
            width="20"
            height="21"
        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <section className="col-span-12 lg:col-span-8">
            {/* 티켓 주문 상세 */}
            <div className="mb-4">
              <h1 className="text-[16px] font-bold text-[#23222A]">
                티켓 주문 상세
              </h1>
            </div>
            ...
            <div className="bg-white py-5">
              {/* 공연 제목 + 일시 */}
              <div className="text-[16px] font-semibold text-[#23222A]">
                {"뮤지컬 <킹키부츠>"}
              </div>
              <div className="text-[16px] font-regular text-[#68677E]">
              ...
              <div className="mt-4 flex gap-4">
                <div className="text-[14px] font-medium text-[#68677E] w-16 shrink-0">
                  좌석 정보
                </div>
              ...
              <div className="mt-2 flex gap-4 text-sm">
                <span className="text-[14px] font-medium text-[#68677E] w-16 shrink-0">
                  가격 정보
                </span>
            ...
            <div className="mt-6">
              <div className="py-4 flex items-start gap-1">
                {/* 필수 표시 * 추가 (피그마 기준) */}
                <h2 className="text-[16px] font-bold text-[#23222A]">
                  예약자 정보
                </h2>
                <svg
                  width="4"
            ...
            <div className="mt-6">
              ...
              <div>
                ...
                <AgreeRow
                  label="(필수) 티켓 이용정책 동의"
                  checked={agrees[1]}
                  onChange={() => handleAgree(1)}
                />
                <AgreeRow
                  label="개인정보 제 3자 제공 안내"
                  checked={agrees[2]}
          ...
          <aside className="col-span-12 lg:col-span-4">
            <div className="lg:sticky lg:top-6">
              <div className="rounded-xl border border-[#DDDDE4] bg-white p-5">
                <h3 className="text-[16px] font-bold text-[#23222A]">
                  결제 정보
                </h3>
                ...
                <div className="mt-4 space-y-3 text-sm">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="text-[16px] font-medium text-[#68677E] shrink-0">
                      티켓금액
                    </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="text-[16px] font-bold text-[#68677E]">
                    최종 결제금액
                  </div>
                  <div className="text-[16px] font-bold text-[#F11322]">
...
function FormRow({
  ...
  return (
    <div className="flex items-start gap-3 py-1">
      <div className="text-[14px] font-medium text-[#68677E] w-16 shrink-0 pt-2">
        {label}
      </div>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <span
          className={`text-sm font-bold ${checked ? "text-[#F11322]" : "text-[#B9B9C6]"}`}
        >
          ✓
        </span>
