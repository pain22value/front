  ...
  return (
    <div className="relative w-full h-full overflow-hidden bg-background border rounded-xl shadow-sm/">
      ...
      <div className="w-full h-full overflow-y-auto">
        <CommentSection artistId={artistId} postId={selectedPostId} onCommentClick={() => setShowDetail(true)} />
      </div>
      ...
      >
        <ArtistCommentDetail artistId={artistId} postId={selectedPostId} onBack={() => setShowDetail(false)} />
      </div>
    </div>
  );
}
