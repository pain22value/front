...
import ArtistIntroTab from "./ArtistIntroTab";
...
export default function ArtistDetailTabs({ artistId }: { artistId: string }) {
  ...
  const { activeTab, setActiveTab } = useArtistStore();
  ...
  const tabs = [
    {
      value: "intro",
      label: "아티스트 소개",
      content: <ArtistIntroTab artistId={artistId} data={data} isLoading={isLoading} />,
    },
    {
      value: "posts",
      label: "아티스트 포스트",
