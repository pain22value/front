...
export default function SuccessClient({ searchParams }: Props) {
  ...
  return (
    <main className="flex flex-col items-center justify-center py-16 px-4">
      ...
      {/* 예매 정보 카드 */}
      <div className="mt-8 w-full max-w-[504px] rounded-xl border border-[#DDDDE4] bg-white">
        {/* 예매 번호 */}
        ...
        <div className="mx-6 mt-2 h-px bg-[#F1F1F4]" />
        {/* 상세 정보 */}
        <div className="space-y-1 px-6 py-4 text-[14px] font-medium text-[#68677E]">
