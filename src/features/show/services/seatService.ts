...
const getSeatList = async (
  showScheduleId: number,
  sessionToken: string = "0a828940-798b-4bd1-a404-e51d09cc1e37" // swagger로 받은 session token 하드코딩
  ...
  const { data } = await api.get<ApiResponse<{ sections: ApiSection[] }>>(
    ...
    { 
      headers: {
        ...
        // access token 하드 코딩
        "Authorization": `Bearer eyJhbGciOiJIUzI1NiJ9..RsXhqo-Yxew2Pt6ivsUDQ69fVgZIE48-v31j1uk5ebM` // 아까 받은 토큰
      }
    }
  );
...
const holdSeats = async (
  ...
  seatIds: number[],
  // session token 자리
  sessionToken: string = "0a828940-798b-4bd1-a404-e51d09cc1e37",
): Promise<string | null> => { 
  const { data } = await api.post<ApiResponse<string>>(
    ...
    { 
      headers: {
        ...sessionHeader(sessionToken),
        // access token 자리
        "Authorization": `Bearer eyJhbGciOiJIUzI1NiJ9..RsXhqo-Yxew2Pt6ivsUDQ69fVgZIE48-v31j1uk5ebM`,
      }
    }
  );
  return data.data;
