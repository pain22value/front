...
return (
  <div className="flex-1 py-10 bg-white min-h-screen">
    <div className="max-w-2xl mx-auto px-4">  {/* ← 이 안에 전부 다 */}
      ...
      {isConfirmed && (
        <div className="rounded-lg px-5 py-3 mb-5 bg-[#FFF5F6]">
      ...
      <p className="text-[13px] text-[#68677E] mb-4">
        예매번호{" "}
        <span className="text-[#23222A] font-medium">{booking.orderId}</span>
      </p>

      <div className="flex gap-4 mb-8">
        <div className="w-[64px] h-[90px] rounded-md flex-shrink-0 overflow-hidden bg-gray-200">
          <img
            ...
            onError={(e) => {
              ...
              el.parentElement!.style.background = "#e5222a";
            }}
          />
        </div>
